...
string OpenSSLUtils::md5(string text)
{
    // md5 hash
...
string OpenSSLUtils::sha256(string text)
{
    // sha256 hash
    unsigned char mdStr[33] = {0};
...
string OpenSSLUtils::base64_encode(string text)
{
    std::string ret;
...
string OpenSSLUtils::base64_decode(string text)
{
    int in_len = text.size();
    int i = 0;
    int j = 0;
...
string OpenSSLUtils::aes_encrypt(string text)
{
...
string OpenSSLUtils::aes_decrypt(string base64_encode_text)
{
    string text = base64_decode(base64_encode_text);
